#######The below is only for environment set up #########

#Set environment to Azure Government
#for testing on private sandbox# az cloud set --name azurecloud

az cloud set --name AzureUSGovernment

#Graphically login into Azure (pick one pending on your environment)
#Connect-AzAccount
Az login
#Confirm you are on the right account (Optional/ick one pending on your environment)
#az account show
Get-AzContext

#clear and prepare for below.

####The param portion should run separately after environemnt set up above through run selection or f8########
